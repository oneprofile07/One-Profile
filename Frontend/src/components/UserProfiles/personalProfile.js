        ...
        <div className='d-flex flex-wrap justify-content-evenly gap-4'>
            <div className="card personalcard1-img d-flex align-items-center justify-content-center flex-column text-center" style={{ width: "18rem", height: "500px", color: `${personalProfileCard[0].textcolor}`, background: `url(${personalProfileCard[0].img1}) center/cover no-repeat` }}>
                <div className="card-body p-5 m-0">
                    <img src="https://bootdey.com/img/Content/avatar/avatar7.png" className="m-0 rounded-circle bg-light border border-3 border-secondary p-1 bg-light" width="110px" height="110px" alt="..." />
                    <p className="card-text p-0 m-0 mt-3">Raj Thakur</p>
                    ...
                    <div className='d-flex justify-content-between mt-2'>
                        ...
                        <p className="card-text text-secondary p-0 m-0">Indore</p>
                    </div>
                    <hr />
