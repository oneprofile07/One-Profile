      ...
      <div class="col-12 col-lg-6 col-xl-7">
        <div class="row justify-content-xl-center">
          <div class="col-12 col-xl-11">
            ...
            <p class="lead fs-4 text-secondary mb-3">We help people to build incredible Profile and superior services. Our perspective is to furnish outstanding captivating services.</p>
            ...
            <div class="row gy-4 gy-md-0 gx-xxl-5X">
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  ...
                  <div>
                    <h2 class="h4 mb-3">Versatile Profile</h2>
              ...
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  ...
                  <div>
                    <h2 class="h4 mb-3">Digital Card</h2>
