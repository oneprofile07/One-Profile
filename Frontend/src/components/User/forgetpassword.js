...
// import images from './d4d7c1b4-98c5-4859-836b-294d65cbd56c.be0ab837448c28bf10ffa8eb4955cdf8.webp'
...
export default function ForgetPassword() {
    ...
    const verifyOTP = () => {
        axios.post("http://localhost:8080//", { email, otp })
            .then((res) => {
                Swal.fire({
                    position: "center",
                    icon: "success",
                ...
                <div className="row border rounded-5 p-3 bg-white shadow box-area mt-5">
                    <div className="col-md-6 p-0 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style={{ background: "#103cbe" }}>
                        <div className="featured-image">
                            {/* <img src={images} className="rounded-4" style={{ width: "300px" }} /> */}
                        </div>
